      ...
      <div className="bio">
        <div>
          <motion.p variants={polyVariant} className="lead">
            Not your standard developer, I have a background in design and have made my way through a broad
            range of industries including DNS, domain registration, marketing,
            gaming and hospitality, and entertainment—my current focus includes
            web3, frontend and visual design.
          </motion.p>
          <motion.div variants={polyVariant}>
            ...
            >
              ...
              in balance. */}
                  Design is much more than what you see, it is
                  informed harmonic balance. My practice is based on a
                  design-first approach—where research and discovery is just as
            ...
            >
              <div className="accordion-inner">
                <p>
                  ...
                  It&apos;s also at the core of my relationship with my clients.
                  I collaborate with a range of folks that recognize the value
                  of design and I continue to work alongside them as they grow.
                </p>
              </div>
            </Accordion>
          </motion.div>
